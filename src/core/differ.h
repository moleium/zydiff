...
class binary_differ {
  ...
  struct compare_options {
    double minimum_similarity{0.7};
    double fallback_similarity{0.5};
    uint64_t address_match_radius{0x20000};
    size_t max_pairwise_candidates{5'000'000};
  ...
  struct diff_result {
    ...
    size_t primary_subroutine_count{0};
    size_t secondary_subroutine_count{0};
    size_t skipped_pairwise_candidates{0};
  };
  ...
  size_t skipped_pairwise_candidates_{0};
};
